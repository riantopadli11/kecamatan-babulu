                    ...
                    <?php foreach ($data->result() as $row): ?>
                        <article class="single-blog-post post-style-4 d-flex align-items-center">
                            ...
                            <div class="post-thumbnail">
                                <a href="<?= site_url('potensi/vw:' . $row->slug); ?>">
                                    <img src="<?= base_url('assets/images/potensi/' . $row->gambar); ?>" 
                                         alt="<?= htmlspecialchars($row->judul); ?>" 
                                         class="img-fluid gabr"> </a>
                            </div>

                            <div class="post-content">
                                <a href="<?= site_url('potensi/vw:' . $row->slug); ?>" class="headline">
