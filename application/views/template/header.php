...
<head>
	...
	<meta name="keyword" content="Kecamatan Babulu, Babulu, Web Kecamatan Babulu">
	<meta name="description" content="website resmi kecamatan babulu">
	<!-- nggo responsive -->
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<!-- favicon -->
	<link rel="icon" href="<?=base_url('assetss/favicon/') . $iden['favicon']?>">
	<title><?php echo SITE_NAME . "  Babulu - " . ucfirst($this->uri->segment(1)) ?></title>
	<!-- Bootstrap core CSS -->
