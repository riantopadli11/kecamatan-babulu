...
<header>
  <nav class="navbar navbar-expand-xl navbar-dark fixed-top main-navbar">
    <div class="container">
      <a class="navbar-brand" href="<?php echo site_url() ?>">
        <img src="<?php echo base_url() . 'assetss/favicon/' . $iden['brand'] ?>" class="navbar-logo" alt="Brand Logo">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown <?php if ($this->uri->segment(1) == "sambutan" || $this->uri->segment(1) == "strukturorganisasi" || $this->uri->segment(1) == "visimisi" || $this->uri->segment(1) == "profilpegawai" || $this->uri->segment(1) == "desa") { echo 'active'; } ?>">
          ...
          <li class="nav-item dropdown <?php if ($this->uri->segment(1) == "berita" || $this->uri->segment(1) == "agenda" || $this->uri->segment(1) == "pengumuman") { echo 'active'; } ?>">
          ...
          <li class="nav-item dropdown <?php if ($this->uri->segment(1) == "alurpelayanan" || $this->uri->segment(1) == "denahpelayanan" || $this->uri->segment(1) == "jenispelayanan") { echo 'active'; } ?>">
          ...
          <li class="nav-item dropdown <?php if ($this->uri->segment(1) == "gallery" || $this->uri->segment(1) == "download") { echo 'active'; } ?>">
        ...
        <form class="form-inline ml-auto" action="<?php echo site_url('berita/search'); ?>" method="get">
          <input class="form-control mr-sm-2 search-input" type="text" placeholder="Cari..." aria-label="Search" name="keyword">
          <button class="btn btn-outline-light my-2 my-sm-0 search-button" type="submit">Cari</button>
        </form>
      </div>
    </div>
  </nav>
